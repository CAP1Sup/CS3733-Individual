export type BoardConfig = {
  ...
  ninjaRow: string;
  ninjaColumn: string;
  initial: { color: string; row: string; column: string }[];
};

export const config_4x4: BoardConfig = {
...
export const config_5x5: BoardConfig = {
...
export const config_6x6: BoardConfig = {
